 ...
 * Generated at: 2018-11-17 14:14:12 UTC
...
//if(confirm!=null){
	...
	if(tr){//cur compare stdate	
			...
			String dd="select booking.start_date,booking.end_date from booking,room where room.rid=booking.rid and room.rno='"+rno+"'";
			stmt=con.createStatement();
			...
			//String st="";
				...
				if(stdate.compareTo(ed)>0|| sd.compareTo(eddate)>0){
					...
					if(sd.compareTo(startdate)!=0 && ed.compareTo(enddate)!=0){
					r=false;
					break;
					}
			...
			if(r){
				/* String g="select gid from guest where name='"+name+"'and password='"+pass+"'";
				stmt=con.createStatement();
				...
				while(rs.next()){
					gid=rs.getInt("gid");
					System.out.println("gid by name and password ... "+gid);
				}
				
				String sql2="select rid from room where rno='"+rno+"'";
				stmt=con.createStatement();
				...
				//String b="select booking.bid from booking,room,guest where booking.rid=room.rid and booking.gid=guest.gid and room.rid="+rid+"and guest.gid="+gid;
		String st="select booking.bid from booking where booking.rid="+rid +" and booking.gid="+gid;
				stmt=con.createStatement();
				...
				*/
				...
				ps.setInt(3,bid);
				ps.executeUpdate();
				String str="<h2>Successful Update !<br>Changing Room No "+rno+"<br>Start Date From "+startdate+" to "+sdate+"<br>End Date From "+enddate+" to "+edate+"</h2>";
				out.println(str);
				//out.println(str);
      ...
      out.write("\t\t");
				...
				String str="<h2>Unsuccessful Update !<br>Please choose another date.</h2> ";
			out.println(str);
			}// r else closing
		}//tr if
else{//tr else
			String str="<h2>You can't check-in cause of your date out. <br>Please try again!</h2>";
			out.println(str);		
} //tr else closing
