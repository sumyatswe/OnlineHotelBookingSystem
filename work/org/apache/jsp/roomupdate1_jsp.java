 ...
 * Generated at: 2019-08-21 16:04:51 UTC
...
if(result){
      ...
      out.write("\t\t\t\t\t\t\t\t");
      if (true) {
        _jspx_page_context.forward("available1.jsp" + "?" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("str", request.getCharacterEncoding())+ "=" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode(String.valueOf(str ), request.getCharacterEncoding()));
        return;
      }
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t<th class=\"th\">Room Type</th>\r\n");
